...
class PretrainedTransformerWithCharactersBackbone(Backbone):
    ...
    def __init__(
        ...
        *,
        ...
        if self._sentence_character_encoder:
            ...
            self._dummy_tensor = torch.nn.Parameter(torch.zeros([self._sentence_character_encoder.get_output_dim() * 2]))
    ...
    def forward(self,
        ...
        if sentence_characters:
            ...
            encoded_sentence_characters = self._sentence_character_encoder(embedded_sentence_characters, sentence_character_mask)
